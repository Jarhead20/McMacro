...
@Mod(
        modid = Mcmacro.MOD_ID,
        name = Mcmacro.MOD_NAME,
        version = Mcmacro.VERSION
)
public class Mcmacro {

    public static final String MOD_ID = "mcmacro";
    public static final String MOD_NAME = "Mcmacro";
    public static final String VERSION = "1.0-SNAPSHOT";

    /** This is the instance of your mod as created by Forge. It will never be null. */
    @Mod.Instance(MOD_ID)
    public static Mcmacro INSTANCE;
